...
product_manager = autogen.AssistantAgent(
    ...
    until admin approval. The plan may involve an engineer who can write code and an architect who doesn't write code. 
    Explain the plan first. Be clear which step is performed by an engineer, and which step is performed by a 
    architect.""",
    llm_config=llm_config,
)
...
if request and submit:
    ...
    st.write(user_proxy.last_message()["content"])
